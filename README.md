...
# Levantar los 3 servicios (modo detached: libera el terminal)
docker compose up --build -d

# Aplicar la migración de base de datos
# IMPORTANTE: debe ejecutarse dentro del contenedor porque el hostname
# "postgres" solo resuelve desde la red Docker, no desde el host
